...
#Inverte um número usando operações de soma, multiplicação, divisão e resto da divisão
#Números que terminam com 0 não são invertidos corretamente(Pq o python não permite isso com inteiros)
...
#Usa a função acima pra identificar se o número é um palíndromo
